...
export const MenuSection = ({ onAddToCart, onCustomizeItem }: MenuSectionProps) => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Ingredientes frescos, sabores únicos e a qualidade que você merece
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((category) => (
            <Button
              ...
              className={selectedCategory === category ? "btn-hero" : "btn-outline-yellow"}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map((item) => (
            <Card key={item.id} className="card-elevated hover:scale-105 transition-all duration-300 group">
